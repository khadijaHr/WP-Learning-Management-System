<?php
add_shortcode('detail_formations', 'cap_detail_day_for_shortcode');

function cap_detail_day_for_shortcode() {
    ...
    include CAP_PLUGIN_DIR . 'includes/templates/detail_formation.php';
    return ob_get_clean();
}