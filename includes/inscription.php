...
add_shortcode('liste_des_participants', 'cap_liste_des_participants_shortcode');

function cap_liste_des_participants_shortcode() {
    ...
    include CAP_PLUGIN_DIR . 'includes/templates/inscrit.php';
    return ob_get_clean();
}

//
add_shortcode('participants', 'cap_participants_shortcode');

function cap_participants_shortcode() {
    // Démarrer la session si nécessaire
    if (!session_id()) {
        session_start();
    }
    ...
    include CAP_PLUGIN_DIR . 'includes/templates/participants.php';
    return ob_get_clean();
}

add_shortcode('coachs', 'cap_coachs_shortcode');
function cap_coachs_shortcode() {
    // Démarrer la session si nécessaire
    if (!session_id()) {
        session_start();
    }
    ...
    include CAP_PLUGIN_DIR . 'includes/templates/coachs.php';
    return ob_get_clean();
}