<div class="liste_participants">
    ...
    <!-- Popup d'inscription -->
    <div class="modal" id="inscriptionModal" style="display: none;">
        <div class="modal-content-user">
            <div class="modal-header">
                <h2 class="modal-title">Nouveau Participant</h2>
                <button class="close-btn" id="closeModal">&times;</button>
            </div>
            <form id="inscriptionForm" class="inscriptionForm" enctype="multipart/form-data">
                <!-- Section Photo -->
                ...
                <div class="form-section">                    
                    <div class="row">  
                        ...
                        <div class="form-group">
                            <label for="date_inscription">Date d'inscription <span>*</span></label>
...
<script>
    ...
    const users = <?php echo get_all_participants_by_coach_data(); ?>;
    ...
    tableBody.addEventListener('change', function(e) {
        if (e.target.classList.contains('checkbox')) {
            ...
            // Vérifier si toutes les cases sont cochées pour le "select all"
    ...
    // Gestion de la popup d'inscription
    const inscriptionBtn = document.querySelector('.btn-primary');
    const inscriptionModal = document.getElementById('inscriptionModal');
    const closeModalBtn = document.getElementById('closeModal');
    const cancelInscriptionBtn = document.getElementById('cancelInscription');
    ...
    cancelInscriptionBtn.addEventListener('click', closeModal);

    // Fermer quand on clique en dehors de la popup
    inscriptionModal.addEventListener('click', function(e) {
